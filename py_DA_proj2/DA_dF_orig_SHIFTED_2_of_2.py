...
savetxt("data/Aiz_or_npk.txt", sum_Li3    )
savetxt("data/Aiz_or_042.txt", sum_Li3_042)
savetxt("data/Aiz_or_062.txt", sum_Li3_062)
savetxt("data/Aiz_or_082.txt", sum_Li3_082)
savetxt("data/Aiz_or_102.txt", sum_Li3_102)
savetxt("data/Aiz_or_132.txt", sum_Li3_132)
savetxt("data/Aiz_or_182.txt", sum_Li3_182)
...
savetxt("data/dAiz_or_042.txt",-dF_042)
savetxt("data/dAiz_or_062.txt",-dF_062)
savetxt("data/dAiz_or_082.txt",-dF_082)
savetxt("data/dAiz_or_102.txt",-dF_102)
savetxt("data/dAiz_or_132.txt",-dF_132)
savetxt("data/dAiz_or_182.txt",-dF_182)
...
#pp.savefig()
#pl.savefig('130807_plots/fig4b_shifted_peaks_F_dF.pdf')
#pl.savefig('Fig4b.pdf')
#pl.savefig('plots/130911_Hopkins_shifted_peaks_A_deltaA.png', dpi = 300)
