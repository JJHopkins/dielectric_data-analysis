...
noise0 = normal(0,0.05,len(x_nopeak))  
noise1 = normal(0,0.05,len(x_042_peak))
noise2 = normal(0,0.05,len(x_062_peak))
noise3 = normal(0,0.05,len(x_082_peak))
noise4 = normal(0,0.05,len(x_102_peak))
noise5 = normal(0,0.05,len(x_132_peak))
noise6 = normal(0,0.05,len(x_182_peak))
...
pl.xlabel(r'$\hbar\omega\,\,[eV]$', size = 21)
pl.ylabel(r'$\epsilon$"($\omega$)', size = 21)
pl.savefig('plots/eps2_org.png', dpi = 300)
