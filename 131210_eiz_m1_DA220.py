...
noise0 = normal(0,0.20,len(x_nopeak))  
noise1 = normal(0,0.20,len(x_042_peak))
noise2 = normal(0,0.20,len(x_062_peak))
noise3 = normal(0,0.20,len(x_082_peak))
noise4 = normal(0,0.20,len(x_102_peak))
noise5 = normal(0,0.20,len(x_132_peak))
noise6 = normal(0,0.20,len(x_182_peak))
...
pl.savefig('plots/eps2_m1_sigma10.png', dpi = 300)
pl.show()
...
#         
savetxt("data/eiz_npk_meas1.txt", eiz_nopeak)
savetxt("data/eiz_042_meas1.txt", eiz_042_peak)
savetxt("data/eiz_062_meas1.txt", eiz_062_peak)
savetxt("data/eiz_082_meas1.txt", eiz_082_peak)
savetxt("data/eiz_102_meas1.txt", eiz_102_peak)
savetxt("data/eiz_132_meas1.txt", eiz_132_peak)
savetxt("data/eiz_182_meas1.txt", eiz_182_peak)
#
pl.close()
