...
eiz_nopeak   = np.loadtxt('data/eiz_npk_meas.txt'  , unpack=True, usecols = [0])
eiz_042_peak = np.loadtxt('data/eiz_042_meas.txt', unpack=True, usecols = [0])
eiz_062_peak = np.loadtxt('data/eiz_062_meas.txt', unpack=True, usecols = [0])
eiz_082_peak = np.loadtxt('data/eiz_082_meas.txt', unpack=True, usecols = [0])
eiz_102_peak = np.loadtxt('data/eiz_102_meas.txt', unpack=True, usecols = [0])
eiz_132_peak = np.loadtxt('data/eiz_132_meas.txt', unpack=True, usecols = [0])
eiz_182_peak = np.loadtxt('data/eiz_182_meas.txt', unpack=True, usecols = [0])
...
savetxt("data/Aiz_m0_npk.txt", sum_Li3    )
savetxt("data/Aiz_m0_042.txt", sum_Li3_042)
savetxt("data/Aiz_m0_062.txt", sum_Li3_062)
savetxt("data/Aiz_m0_082.txt", sum_Li3_082)
savetxt("data/Aiz_m0_102.txt", sum_Li3_102)
savetxt("data/Aiz_m0_132.txt", sum_Li3_132)
savetxt("data/Aiz_m0_182.txt", sum_Li3_182)
...
savetxt("data/dAiz_m0_042.txt",-dF_042)
savetxt("data/dAiz_m0_062.txt",-dF_062)
savetxt("data/dAiz_m0_082.txt",-dF_082)
savetxt("data/dAiz_m0_102.txt",-dF_102)
savetxt("data/dAiz_m0_132.txt",-dF_132)
savetxt("data/dAiz_m0_182.txt",-dF_182)
...
savetxt("data/deiz_m0_042.txt",diff_eiz_042)
savetxt("data/deiz_m0_062.txt",diff_eiz_062)
savetxt("data/deiz_m0_082.txt",diff_eiz_082)
savetxt("data/deiz_m0_102.txt",diff_eiz_102)
savetxt("data/deiz_m0_132.txt",diff_eiz_132)
savetxt("data/deiz_m0_182.txt",diff_eiz_182)
